(define 
    ...
    (:init
		...
		(= (time_requested r1 k73) 730)
		(= (temp_requested r1 k73) 14)
		(= (time_requested r1 k74) 740)
		(= (temp_requested r1 k74) 20)
		(= (time_requested r1 k75) 750)
		(= (temp_requested r1 k75) 14)
		(= (time_requested r1 k76) 760)
		(= (temp_requested r1 k76) 20)
